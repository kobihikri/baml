...
impl TyTemplate {
    ...
    pub fn substitute_with_fuel<C: TypeContext>(
        ...
        match self {
            ...
            Self::WatchAccessor(inner, attr) => Ok(RealizedTy::WatchAccessor(
                Box::new(inner.substitute_with_fuel(type_args, ctx, fuel)?),
                attr.clone(),
            )),
    ...
    pub fn substitute_symbolic(&self, type_args: &[RuntimeTy]) -> RuntimeTy {
        match self {
            ...
            Self::WatchAccessor(inner, attr) => RuntimeTy::WatchAccessor(
                Box::new(inner.substitute_symbolic(type_args)),
                attr.clone(),
            ),
            Self::AssociatedTypeProjection {
                base,
